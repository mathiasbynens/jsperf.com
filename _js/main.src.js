...
$(function() {
 ...
 var $title = $('#title'),
     ...
     $addMooTools = $('<button id="add-mootools">MooTools</button>').addScript('mootools/1.3/mootools-yui-compressed'),
     $addYUI = $('<button id="add-yui">YUI</button>').addScript('yui/2.9.0/build/yuiloader/yuiloader-min'),
     $addPrototype = $('<button id="add-prototype">Prototype</button>').addScript('prototype/1/prototype'),
     $addDojo = $('<button id="add-dojo">Dojo</button>').addScript('dojo/1/dojo/dojo.xd'),
     $addExt = $('<button id="add-ext">Ext Core</button>').addScript('ext-core/3/ext-core'),
     $addMyLib = $('<button id="add-ext">My Library</button>').addScript('mylib099-min', true),
