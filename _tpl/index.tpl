...
<form action="/" method="post">
	...
	<fieldset>
		...
		<fieldset>
			...
			<div>
				<label for="prep-html">Preparation code HTML <span>(this will be inserted in the <code>&lt;body></code> of a valid HTML5 document in standards mode)</span> <span>(useful when testing DOM operations or including libraries)</span> <span>(use <a href="https://rawgithub.com/">rawgithub.com</a> instead of raw.github.com)</span> </label><?php epv('prep-html', 1); ?>
